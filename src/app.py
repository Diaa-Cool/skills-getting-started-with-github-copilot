...
activities = {
    ...
    "Soccer Team": {
        "description": "Join our competitive soccer team for practice and matches",
        "schedule": "Mondays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["mrihanna@mergington.edu", "taylan@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Shoot hoops, develop teamwork, and play friendly games",
    ...
    "Math Circle": {
        "description": "Solve challenging math problems and explore new concepts",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
